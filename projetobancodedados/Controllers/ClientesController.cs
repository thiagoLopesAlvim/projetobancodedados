...
namespace projetobancodedados.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nomec,Cpfc,DataNascimento")] Clientes clientes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nomec,Cpfc,DataNascimento")] Clientes clientes)
        {
            if (id != clientes.Id)
            {
                return NotFound();
